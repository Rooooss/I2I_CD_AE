...
real_Images = [Image.open(file) for file in glob.glob('C:/Users/Joohong/Desktop/2019/CycleGAN-tensorflow/datasets/cityscapes/testA/*jpg')]
...
if __name__ == '__main__':
    ...
    for i in range(len(real_Images)):
        realImages.append(np.array(real_Images[i]))
    ...
    real_mean, real_std = get_inception_score(realImages, splits=10)
    val_mean, val_std = get_inception_score(valImages, splits=10)
